...
Since all [MIMIC-III keys are int4](https://mit-lcp.github.io/mimic-schema-spy/columns.byTable.html) values, we'll use bigint = "integer".
...
knitr HTML rendered WITHOUT `bigint = "integer"` in dbConnect:
