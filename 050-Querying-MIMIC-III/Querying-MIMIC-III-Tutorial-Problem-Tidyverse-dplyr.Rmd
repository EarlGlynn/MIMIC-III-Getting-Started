...
### Step 7 (FIX ME to match PostgresQL results)

NOTE:  There's something wierd (for me) going on with the time comparisons in computing icuStayExpireFlag.  There are unexplainable results using only the case "deathtime <= intime".
